      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-9 text-center mx-auto">
            <h1 class="text-white pt-3 mt-n5">Potads</h1>
            <p class="lead text-white mt-3">Mengenal & Konsultasi mengenai Tantrum Anak Down Syndrome. <br /> "Kesabaran yang akan membuahkan manis, bersyukur dan rawatlah dengan penuh cinta"</p>


            <a href="./pages/konsultasi.php" class="btn btn-sm  bg-gradient-primary  mb-0 me-1 mt-2 mt-md-0">Konsultasi</a>
