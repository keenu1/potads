...
<body class="index-page bg-gray-200">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" id="contact-form" method="post" action="phpadmingejalainsert.php" autocomplete="off">
            <div class="card-body">
              <div class="input-group input-group-dynamic mb-4">
                <label class="form-label">Kode Gejala</label>
                <input class="form-control" aria-label="kode_gejala" type="text" name="kode_gejala">
              </div>
              <div class="input-group input-group-dynamic mb-4">
                <label class="form-label">Gejala</label>
                <input type="text" class="form-control" placeholder="" aria-label="gejala" name="gejala">
              </div>
              <div class="input-group input-group-dynamic mb-4">
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="text-center">
                          ...
                          <button type="button" class="btn btn-warning btn-sm w-auto me-1 mb-0 pt-2" data-bs-toggle="modal" data-bs-target="#exampleModal2<?php echo $data['kode_gejala']; ?>">
  ...
  foreach ($query as $data) {
  ?>
    <div class="modal fade " id="exampleModal2<?php echo $data['kode_gejala']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Perbarui Data Gejala</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <form role="form" id="contact-form" method="post" action="phpadmingejalaupdate.php" autocomplete="off">
              <div class="card-body">
                <div class="input-group input-group-static mb-4">
                  <label>Kode Gejala</label>
                  <input class="form-control" aria-label="kode_gejala_baru" type="text" name="kode_gejala_baru" value="<?php echo  $data['kode_gejala'] ?>">
                </div>
                <input class="form-control" hidden aria-label="kode_gejala_lama" type="text" name="kode_gejala_lama" value="<?php echo  $data['kode_gejala'] ?>">
                <div class="input-group input-group-static mb-4">
                  <label>Gejala</label>
                  <input type="text" class="form-control" placeholder="" aria-label="gejala" name="gejala" value="<?php echo  $data['nama_gejala'] ?>">
                </div>
                <div class="input-group input-group-static mb-4">
                  <label>Bobot</label>
